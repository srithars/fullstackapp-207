pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://43.205.117.129:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/srithars/fullstackapp-207.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://43.205.117.129:9090/springapp1"
            echo "✅ Frontend deployed: http://43.205.117.129:9090/frontapp1"
        }
        failure {
